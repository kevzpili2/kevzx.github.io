...
<head>
    ...
    <title>Ignisense: System Access</title>
...
<body class="h-screen w-full overflow-hidden flex flex-col md:flex-row">
    ...
    <div class="w-full md:w-1/2 lg:w-[45%] h-full bg-[#050202] flex items-center justify-center p-6 relative page-transition" style="animation-delay: 0.2s;">
        <!-- Corner Accents -->
        ...
        <div class="w-full max-w-sm z-20">
            ...
            <div class="mb-10">
                ...
                <p class="text-gray-500 text-sm">Please identify yourself to proceed.</p>
            </div>
            ...
            <div id="error-box" class="hidden bg-red-950/30 border-l-4 border-red-600 p-4 mb-6 backdrop-blur-sm">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-red-200 text-sm font-medium" id="error-msg">Access Denied</p>
                </div>
            </div>
            ...
            <form id="login-form" class="space-y-6">
                ...
                <button type="submit" id="login-btn" class="w-full group relative overflow-hidden bg-red-700 hover:bg-red-600 text-white font-display font-bold py-4 px-4 rounded-lg transition-all shadow-[0_0_20px_rgba(185,28,28,0.2)] hover:shadow-[0_0_30px_rgba(220,38,38,0.4)]">
                    ...
                    <span class="flex items-center justify-center gap-2 tracking-wide uppercase">
                        Sign In <i data-lucide="chevron-right" class="w-4 h-4"></i>
                    </span>
                </button>

                <div class="text-center pt-4 border-t border-white/5">
                    <p class="text-gray-500 text-sm">Don't have an account? <a href="register.php" class="text-red-400 hover:text-red-300 font-semibold transition-colors">Register here</a></p>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('login-form').addEventListener('submit', async (e) => {
            ...
            btn.innerHTML = '<span class="animate-pulse tracking-widest">AUTHENTICATING...</span>'; 
            btn.disabled = true;
            ...
            try {
                ...
                if (data.success) {
                    // Success Redirect
                    btn.innerHTML = '<span class="text-green-400 tracking-widest">ACCESS GRANTED</span>';
                    
                    // Simple page transition
                    document.body.style.opacity = '0';
                    setTimeout(() => {
                        window.location.href = data.role === 'admin' ? 'admin.php' : 'user_home.php';
                    }, 500);
                } else {
                    // Show Error
